...
public class GertaerakSortu {
	...
	public static void main(String[] args) {
		 ...
		 * Date()); e.createAndStoreLoginGertaera(3L, "Kepak ondo egin du logina", new
		 * Date());
		 */
		 ...
		 * System.out.println("Gertaeren zerrenda:"); List gertaerak =
		 * e.gertaerakZerrendatu(); for (int i = 0; i < gertaerak.size(); i++) {
		 * LoginGertaera ev = (LoginGertaera) gertaerak.get(i); System.out
		 * .println("Id: " + ev.getId() + " Deskribapena: " + ev.getDeskribapena() +
		 * " Data: " + ev.getData()); }
		 */
